...
#[doc(alias = "form")]
pub struct Form {
    accept_charset: std::option::Option<String>,
action: std::option::Option<String>,
autocomplete: std::option::Option<String>,
enctype: std::option::Option<String>,
method: std::option::Option<String>,
name: std::option::Option<String>,
novalidate: std::option::Option<String>,
