...
pub struct TableHeader {
    colspan: std::option::Option<String>,
rowspan: std::option::Option<String>,
headers: std::option::Option<String>,
scope: std::option::Option<String>,
abbr: std::option::Option<String>,
