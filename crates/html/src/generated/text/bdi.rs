...
pub mod child {
    ...
    impl std::convert::From<crate::generated::all::Form> for BidirectionalIsolateChild {
    ...
    impl std::convert::From<crate::generated::all::Menu> for BidirectionalIsolateChild {
    ...
    impl std::convert::From<crate::generated::all::Table> for BidirectionalIsolateChild {
