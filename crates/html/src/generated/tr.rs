pub mod element {
    ...
    impl TableRow {
        ...
        pub fn builder() -> super::builder::TableRowBuilder {
    ...
    impl crate::Render for TableRow {
        fn render(
            &self,
...
pub mod builder {
    ...
    pub struct TableRowBuilder {
        element: super::element::TableRow,
    }
    impl TableRowBuilder {
        pub(crate) fn new(element: super::element::TableRow) -> Self {
            Self { element }
        }
        /// Finish building the element
        pub fn build(&mut self) -> super::element::TableRow {
            self.element.clone()
        }
        ...
        where
            T: Into<crate::generated::all::children::TableRowChild>,
        {
