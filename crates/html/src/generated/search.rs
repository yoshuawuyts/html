...
pub mod child {
    ...
    impl std::convert::From<crate::generated::all::Link> for SearchChild {
    ...
    impl std::convert::From<crate::generated::all::Meta> for SearchChild {
