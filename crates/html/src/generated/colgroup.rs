pub mod element {
    ...
    impl TableColumnGroup {
        ...
        pub fn set_span(
            ...
            self.sys.span = value.map(|v| v.into());
        }
    ...
    impl crate::Render for TableColumnGroup {
        fn render(
            &self,
...
pub mod child {
    ...
    impl crate::Render for TableColumnGroupChild {
        fn render(
            &self,
            f: &mut std::fmt::Formatter<'_>,
            depth: usize,
...
pub mod builder {
    ...
    impl TableColumnGroupBuilder {
        ...
        pub fn build(&mut self) -> super::element::TableColumnGroup {
            self.element.clone()
        }
        ...
        pub fn span(
            ...
            self.element.set_span(Some(value.into()));
            self
        }
        /// Set the value of the `accesskey` attribute
        pub fn access_key(
        ...
        where
            T: Into<crate::generated::all::children::TableColumnGroupChild>,
        {
