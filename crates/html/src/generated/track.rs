pub mod element {
    ...
    impl TextTrack {
        ...
        pub fn set_kind(
            ...
            self.sys.kind = value.map(|v| v.into());
        }
        ...
        pub fn set_srclang(
            ...
            self.sys.srclang = value.map(|v| v.into());
        }
    ...
    impl crate::Render for TextTrack {
        fn render(
            &self,
...
pub mod builder {
    ...
    impl TextTrackBuilder {
        ...
        pub fn kind(
            ...
            self.element.set_kind(Some(value.into()));
            self
        }
        /// Set the value of the `src` attribute
        pub fn src(
        ...
        pub fn srclang(
            ...
            self.element.set_srclang(Some(value.into()));
            self
        }
        /// Set the value of the `label` attribute
        pub fn label(
        ...
        pub fn default(&mut self, value: bool) -> &mut Self {
            self.element.set_default(value);
            self
        }
        /// Set the value of the `accesskey` attribute
        pub fn access_key(
