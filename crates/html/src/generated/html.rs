pub mod element {
    ...
    impl Html {
        ...
        pub fn builder() -> super::builder::HtmlBuilder {
...
pub mod child {
    ...
    impl crate::Render for HtmlChild {
        fn render(
            ...
            match self {
                Self::Body(el) => crate::Render::render(el, f, depth + 1, autoformat),
                Self::Head(el) => crate::Render::render(el, f, depth + 1, autoformat),
            }
        }
    }
...
pub mod builder {
    ...
    pub struct HtmlBuilder {
        element: super::element::Html,
    }
    impl HtmlBuilder {
        pub(crate) fn new(element: super::element::Html) -> Self {
            Self { element }
        }
        ...
        pub fn build(&mut self) -> super::element::Html {
            self.element.clone()
        }
        ...
        where
            T: Into<crate::generated::all::children::HtmlChild>,
        {
