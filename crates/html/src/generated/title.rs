...
pub mod child {
    ...
    impl std::convert::From<std::borrow::Cow<'static, str>> for TitleChild {
        fn from(value: std::borrow::Cow<'static, str>) -> Self {
            Self::Text(value)
        }
    }
    impl std::convert::From<&'static str> for TitleChild {
        fn from(value: &'static str) -> Self {
            Self::Text(value.into())
        }
    }
    impl std::convert::From<String> for TitleChild {
        fn from(value: String) -> Self {
            Self::Text(value.into())
        }
    }
    impl crate::Render for TitleChild {
        fn render(
            &self,
            f: &mut std::fmt::Formatter<'_>,
            depth: usize,
...
pub mod builder {
    ...
    impl TitleBuilder {
        ...
        pub fn autoformat(&mut self, do_auto_format: Option<bool>) -> &mut TitleBuilder {
            self.element.autoformat = do_auto_format;
            self
        }
        /// Finish building the element
        pub fn build(&mut self) -> super::element::Title {
            self.element.clone()
        }
        ...
        where
            T: Into<crate::generated::all::children::TitleChild>,
        {
