pub mod element {
    ...
    impl Underline {
        ...
        pub fn builder() -> super::builder::UnderlineBuilder {
    ...
    impl crate::Render for Underline {
        fn render(
            &self,
...
pub mod child {
    ...
    impl std::convert::From<crate::generated::all::Audio> for UnderlineChild {
    ...
    impl std::convert::From<crate::generated::all::Canvas> for UnderlineChild {
    ...
    impl std::convert::From<crate::generated::all::Embed> for UnderlineChild {
    ...
    impl std::convert::From<crate::generated::all::Iframe> for UnderlineChild {
        fn from(value: crate::generated::all::Iframe) -> Self {
            Self::Iframe(value)
        }
    }
    impl std::convert::From<crate::generated::all::Image> for UnderlineChild {
    ...
    impl std::convert::From<crate::generated::all::ImageMapArea> for UnderlineChild {
    ...
    impl std::convert::From<crate::generated::all::Link> for UnderlineChild {
    ...
    impl std::convert::From<crate::generated::all::Meta> for UnderlineChild {
    ...
    impl std::convert::From<crate::generated::all::NoScript> for UnderlineChild {
        fn from(value: crate::generated::all::NoScript) -> Self {
            Self::NoScript(value)
        }
    }
    impl std::convert::From<crate::generated::all::Object> for UnderlineChild {
    ...
    impl std::convert::From<crate::generated::all::Picture> for UnderlineChild {
...
pub mod builder {
    /// A builder struct for Underline
    pub struct UnderlineBuilder {
        element: super::element::Underline,
    }
    impl UnderlineBuilder {
        pub(crate) fn new(element: super::element::Underline) -> Self {
            Self { element }
        }
        /// Finish building the element
        pub fn build(&mut self) -> super::element::Underline {
            self.element.clone()
        }
        ...
        where
            T: Into<crate::generated::all::children::UnderlineChild>,
        {
