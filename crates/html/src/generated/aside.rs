...
pub mod child {
    ...
    impl std::convert::From<crate::generated::all::Link> for AsideChild {
    ...
    impl std::convert::From<crate::generated::all::Meta> for AsideChild {
...
pub mod builder {
    ...
    impl AsideBuilder {
        ...
        pub fn autoformat(&mut self, do_auto_format: Option<bool>) -> &mut AsideBuilder {
        ...
        where
            T: Into<crate::generated::all::children::AsideChild>,
        {
