pub mod element {
    ...
    impl OrderedList {
        ...
        pub fn set_reversed(
            ...
            self.sys.reversed = value.map(|v| v.into());
        }
        ...
        pub fn set_start(
            ...
            self.sys.start = value.map(|v| v.into());
        }
    ...
    impl crate::Render for OrderedList {
        fn render(
            &self,
...
pub mod child {
    ...
    impl crate::Render for OrderedListChild {
        fn render(
            &self,
            f: &mut std::fmt::Formatter<'_>,
            depth: usize,
            ...
            match self {
                Self::ListItem(el) => crate::Render::render(el, f, depth + 1, autoformat),
...
pub mod builder {
    ...
    impl OrderedListBuilder {
        ...
        pub fn reversed(
            ...
            self.element.set_reversed(Some(value.into()));
            self
        }
        /// Set the value of the `start` attribute
        pub fn start(
            ...
            self.element.set_start(Some(value.into()));
            self
        }
        /// Set the value of the `type` attribute
        pub fn type_(
        ...
        where
            T: Into<crate::generated::all::children::OrderedListChild>,
        {
