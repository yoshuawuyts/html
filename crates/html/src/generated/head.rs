...
pub mod child {
    ...
    impl crate::Render for HeadChild {
        fn render(
            ...
            match self {
                Self::Base(el) => crate::Render::render(el, f, depth + 1, autoformat),
                ...
                Self::Style(el) => crate::Render::render(el, f, depth + 1, autoformat),
                Self::Title(el) => crate::Render::render(el, f, depth + 1, autoformat),
            }
        }
    }
