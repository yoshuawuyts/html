...
pub mod child {
    ...
    impl crate::Render for StyleChild {
        fn render(
            &self,
            f: &mut std::fmt::Formatter<'_>,
            depth: usize,
...
pub mod builder {
    ...
    impl StyleBuilder {
        ...
        pub fn autoformat(&mut self, do_auto_format: Option<bool>) -> &mut StyleBuilder {
        ...
        where
            T: Into<crate::generated::all::children::StyleChild>,
        {
