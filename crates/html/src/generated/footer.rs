...
pub mod child {
    ...
    impl std::convert::From<crate::generated::all::Link> for FooterChild {
    ...
    impl std::convert::From<crate::generated::all::Meta> for FooterChild {
...
pub mod builder {
    ...
    impl FooterBuilder {
        ...
        where
            T: Into<crate::generated::all::children::FooterChild>,
        {
