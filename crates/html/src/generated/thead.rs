pub mod element {
    ...
    impl TableHead {
        ...
        pub fn children(&self) -> &[super::child::TableHeadChild] {
            self.children.as_ref()
        }
        /// Mutably access the element's children
        pub fn children_mut(&mut self) -> &mut Vec<super::child::TableHeadChild> {
            &mut self.children
        }
    }
    impl crate::Render for TableHead {
        fn render(
            &self,
...
pub mod child {
    ...
    impl std::convert::From<crate::generated::all::Script> for TableHeadChild {
        fn from(value: crate::generated::all::Script) -> Self {
            Self::Script(value)
        }
    }
    impl std::convert::From<crate::generated::all::TableRow> for TableHeadChild {
        fn from(value: crate::generated::all::TableRow) -> Self {
            Self::TableRow(value)
        }
    }
    impl std::convert::From<crate::generated::all::Template> for TableHeadChild {
        fn from(value: crate::generated::all::Template) -> Self {
            Self::Template(value)
        }
    }
    impl crate::Render for TableHeadChild {
        fn render(
            &self,
            f: &mut std::fmt::Formatter<'_>,
            depth: usize,
...
pub mod builder {
    ...
    impl TableHeadBuilder {
        ...
        pub fn build(&mut self) -> super::element::TableHead {
            self.element.clone()
        }
        ...
        where
            T: Into<crate::generated::all::children::TableHeadChild>,
        {
